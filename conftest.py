# Reference: https://vyper.readthedocs.io/en/stable/testing-contracts-ethtester.html
...
def _deploy_blueprint_for(w3, source_code, initcode_prefix=b"", **kwargs):
    out = compiler.compile_code(
        source_code,
        ["abi", "bytecode"],
        interface_codes=kwargs.pop("interface_codes", None),
...
@pytest.fixture(scope="module")
def deploy_blueprint_for(w3):
    def deploy_blueprint_for(source_code, *args, **kwargs):
        return _deploy_blueprint_for(w3, source_code, *args, **kwargs)
